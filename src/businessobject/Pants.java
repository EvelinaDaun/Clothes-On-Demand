...
// Klass Pants - Mall för att skapa upp Pants objekt
public class Pants {
    private int id;
    private static int lastId = 0; // För att öka id för varje skapad
    ...
    public Pants() {
        this.id = ++lastId;
        this.propertyChangeSupport = new PropertyChangeSupport(this); // Skicka med referens till sig själv
    }

    public Pants(int id, String name, String size, double price, String material, String color, String fit, String length, PropertyChangeSupport propertyChangeSupport, boolean inProduction) {
        this.id = id;
        this.name = name;
        this.size = size;
        this.price = price;
